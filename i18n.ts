...
export const translations: Record<string, TranslationSchema> = {
  en: {
    ...
    index: {
      ...
      proc_title_pt1: "You Don't Need to Be",
  ...
  fr: {
    ...
    index: {
      ...
      why_sub_alt: "DevelopIA combine <strong class=\"text-on-surface\">créativité</strong>, <strong class=\"text-on-surface\">ingénierie logicielle</strong>, <strong class=\"text-on-surface\">automatisation</strong> et <strong class=\"text-on-surface\">stratégie d\'entreprise</strong> pour créer des produits numériques modernes, évolutifs et prêts pour la croissance.",
  ...
  es: {
    ...
    index: {
      ...
      proc_title_pt1: "No Necesitas Ser",
  ...
  it: {
    ...
    index: {
      ...
      proc_title_pt1: "Non Devi Essere",
  ...
  ru: {
    ...
    index: {
      ...
      proc_title_pt1: "Вам не нужно быть",
      ...
      why_sub_alt: "DevelopIA объединяет <strong class=\"text-on-surface\">креативность</strong>, <strong class=\"text-on-surface\">программную инженерию</strong>, <strong class=\"text-on-surface\">автоматизацию</strong> и <strong class=\"text-on-surface\">бизнес-стратегию</strong> для создания цифровых продуктов, которые современны, масштабируемы и готовы к росту.",
